...
- Improve terrain loading [#126](https://github.com/starfruitcloud/digitwin/issues/126)
...
- Optimize position bar elevation value [#109](https://github.com/starfruitcloud/digitwin/issues/109)
- Fix the problem of incorrect recovery time of history track several times
- Fix the problem of wrong display of the end of history track[#107](https://github.com/starfruitcloud/digitwin/issues/107)  
...
- Fix a bug that the history track clear function is not working [#102](https://github.com/starfruitcloud/digitwin/issues/102)
- Fix the problem that editing circle doesn't work [#104](https://github.com/starfruitcloud/digitwin/issues/104)
- Fix the problem that some analysis functions can't be used because of removing Cesium.when [#105](https://github.com/starfruitcloud/digitwin/issues/105)
...
- Added scene split
- Added s3m height offset setting [#98](https://github.com/starfruitcloud/digitwin/issues/98)
- Add marker line add max anchor points [#99](https://github.com/starfruitcloud/digitwin/issues/99)
- Add history track add model orientation setting (heading offset) [#100](https://github.com/starfruitcloud/digitwin/issues/100)

#### Fixes 🔧

- Fix the problem that plot plot coordinates are empty [#95](https://github.com/starfruitcloud/digitwin/issues/95)
...
- Improve the terrian name option  [#74](https://github.com/starfruitcloud/digitwin/pull/74)
...
- Improve the MapSwitch [#70](https://github.com/starfruitcloud/digitwin/issues/70)
- Improve the AroundView [#72](https://github.com/starfruitcloud/digitwin/issues/72)
...
- Fix the problem that roaming cannot set parameters and the failed camera cannot move [#65](https://github.com/starfruitcloud/digitwin/issues/65)
- Fix the problem that the gradient setting of heat layer [#66](https://github.com/starfruitcloud/digitwin/issues/66)
- Improve the DivIcon style
...
- Hide the chart layer at the back [#55](https://github.com/starfruitcloud/digitwin/issues/55)
- Hide the div icon at the back [#56](https://github.com/starfruitcloud/digitwin/issues/56)
- Improve the position editor [#57](https://github.com/starfruitcloud/digitwin/issues/57)
- Improve the terrain clipping [#58](https://github.com/starfruitcloud/digitwin/issues/58)

### 2.4.1 - 2021-08-21

#### Additions 🎉

- Add support for layer mouse events [#53](https://github.com/starfruitcloud/digitwin/issues/54)
- Add partial mouse default events [#54](https://github.com/starfruitcloud/digitwin/issues/54)
...
- Add model primitive to get node-related functions [#51](https://github.com/starfruitcloud/digitwin/issues/51)

#### Fixes 🔧

- Improve the history track restore function [#50](https://github.com/starfruitcloud/digitwin/issues/50)
...
- Fix the problem of flickering when analyzing transformation parameters in the viewable field [#37](https://github.com/starfruitcloud/digitwin/issues/37)
- Fix the problem that DivIcon cannot get the current coordinates set to (0,0,0) by default [#38](https://github.com/starfruitcloud/digitwin/issues/38)

### 2.2.4 - 2021-06-12

#### Breaking Changes 📣

- Refactored the roaming function into first-person roaming and keyboard roaming [#34](https://github.com/starfruitcloud/digitwin/issues/34)
- Original roaming function becomes history track, refine its pause and play [#35](https://github.com/starfruitcloud/digitwin/issues/35)

#### Fixes 🔧

- Improve heading function
- Improve diffuse wall primitive
- Fixes RadarScan missing Cesium issue [#33](https://github.com/starfruitcloud/digitwin/issues/33)
...
- Improve the wind layer add fix the issue[#28](https://github.com/starfruitcloud/digitwin/issues/28)
- Repair the problem that the auxiliary view cone of video fusion function cannot be displayed[#29](https://github.com/starfruitcloud/digitwin/issues/29)
- Improve the video primitive 
- Repair the problem that the animation function cannot be used after the scene time is stoped[#31](https://github.com/starfruitcloud/digitwin/issues/31)
...
- Improve the plot module and fix the issue[#26](https://github.com/starfruitcloud/digitwin/issues/26)
...
- Fix the plot bugs[#24](https://github.com/starfruitcloud/digitwin/issues/24)
- Rewritten logo
...
- Fix the problem that AroundPoint and AroundView will be accelerated by multiple starts[#22](https://github.com/starfruitcloud/digitwin/issues/22)
- Fix the problem that mouse events do not work when the overlay is OSGB[#23](https://github.com/starfruitcloud/digitwin/issues/23)
