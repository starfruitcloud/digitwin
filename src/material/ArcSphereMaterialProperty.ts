/*
 * :file description: 电弧球体材质
 * :name: /firethorn/src/material/ArcSphereMaterialProperty.ts
 * :author:张德志
 * :copyright: (c) 2024, Xiaozhi
 * :date created: 2024-08-30 14:48:37
 * :last editor: 张德志
 * :date last edited: 2024-08-30 14:51:18
 */
import * as Cesium from 'cesium';

class ArcSphereMaterialProperty{
    name: string;
    color: Cesium.Color;
    speed: number;
    definitionChanged: Cesium.Event;
    constructor(options:{color:Cesium.Color,speed:number}) {
        this.name = 'ArcSphereMaterialProperty';
    ...
    equals(other: { name: string }) {
        return (
          other instanceof ArcSphereMaterialProperty &&
...
export default ArcSphereMaterialProperty;