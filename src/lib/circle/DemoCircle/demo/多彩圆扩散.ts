/*
 * :file description: 
 * :name: /firethorn/src/lib/circle/DemoCircle/demo/多彩圆扩散.ts
 * :author:张德志
 * :copyright: (c) 2024, Xiaozhi
 * :date created: 2024-08-30 10:25:15
 * :last editor: 张德志
 * :date last edited: 2024-08-30 10:34:00
 */
import * as Cesium from 'cesium';
import "cesium/Build/Cesium/Widgets/widgets.css";
import ColorCircleDiffusion from '@/lib/circle/ColorCircleDiffusion';
...
export default () => {
    ...
    new ColorCircleDiffusion(viewer,{
