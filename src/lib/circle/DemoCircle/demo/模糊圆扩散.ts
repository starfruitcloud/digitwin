/*
 * :file description: 
 * :name: /firethorn/src/lib/circle/DemoCircle/demo/模糊圆扩散.ts
 * :author:张德志
 * :copyright: (c) 2024, Xiaozhi
 * :date created: 2024-08-30 11:50:02
 * :last editor: 张德志
 * :date last edited: 2024-08-30 11:50:12
 */
import * as Cesium from 'cesium';
import "cesium/Build/Cesium/Widgets/widgets.css";
import BlurCircleDiffusion from '@/lib/circle/BlurCircleDiffusion';
...
export default () => {
    ...
    new BlurCircleDiffusion(viewer,{
